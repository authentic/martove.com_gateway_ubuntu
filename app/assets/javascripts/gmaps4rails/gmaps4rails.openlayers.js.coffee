...
class @Gmaps4RailsOpenlayers extends Gmaps4Rails
  ...
  createLatLng: (lat, lng)->
    return new OpenLayers.LonLat(lng, lat).transform(new OpenLayers.Projection("EPSG:4326"),
                                                     new OpenLayers.Projection("EPSG:900913")) # transform from WGS 1984 to Spherical Mercator Projection
